...
// or extension based on the set method.
func Unarchive(source, destination, method string) error {
	var uaIface interface{}
	var err error
	switch method {
	case "header":
	...
	default:
		return fmt.Errorf("method specified is not a valid method")
	}
	if err != nil {
		return err
	}
